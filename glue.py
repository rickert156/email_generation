    ...
    with open('test.csv', 'r') as file_csv:
        for row in csv.DictReader(file_csv):
            ...
            if ' ' in row_name:
                ...
                option_1 = f'{first_name.lower()}.{last_name.lower()}@{row_domain}'#ok
                option_2 = f'{first_name.lower()}{last_name.lower()}@{row_domain}'#ok
                option_3 = f'{first_name.lower()}@{row_domain}'#ok
                option_4 = f'{first_name[0].lower()}.{last_name.lower()}@{row_domain}'#ok
                option_5 = f'{first_name[0].lower()}{last_name.lower()}@{row_domain}'#ok
